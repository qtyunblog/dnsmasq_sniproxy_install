...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/Chinese_domain/dnsmasq.conf
    download /tmp/proxy-domains.txt https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/Chinese_domain/proxy-domains.txt
...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        ...
        download /etc/init.d/sniproxy https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/dlundquist/sniproxy/master/redhat/sniproxy.init && chmod +x /etc/init.d/sniproxy
    elif check_sys packageManager apt; then
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
        ...
        download /etc/init.d/sniproxy https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/dlundquist/sniproxy/master/debian/init.d && chmod +x /etc/init.d/sniproxy
        download /etc/default/sniproxy https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/sniproxy.default
    fi
    ...
    download /etc/sniproxy.conf https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/sniproxy.conf
    download /tmp/sniproxy-domains.txt https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/Chinese_domain/proxy-domains.txt
