...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/dnsmasq.conf
    download /tmp/proxy-domains.txt https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
                download /tmp/sniproxy-0.6.0.el7.x86_64.rpm https://github.com/qtyunblog/dnsmasq_sniproxy_install/raw/master/sniproxy/sniproxy-0.6.0.el7.x86_64.rpm
        ...
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
                download /tmp/sniproxy_0.6.0_amd64.deb https://github.com/qtyunblog/dnsmasq_sniproxy_install/raw/master/sniproxy/sniproxy_0.6.0_amd64.deb
                error_detect_depends "dpkg -i --no-debsig /tmp/sniproxy_0.6.0_amd64.deb"
                rm -rf /tmp/sniproxy_0.6.0_amd64.deb
            elif [[ ${bit} = "i386" ]]; then
                download /tmp/sniproxy_0.6.0_i386.deb https://github.com/qtyunblog/dnsmasq_sniproxy_install/raw/master/sniproxy/sniproxy_0.6.0_i386.deb
        ...
        download /etc/default/sniproxy https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/sniproxy.default
    fi
    ...
    download /etc/sniproxy.conf https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/sniproxy.conf
    download /tmp/sniproxy-domains.txt https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/proxy-domains.txt
