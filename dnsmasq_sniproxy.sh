...
install_dnsmasq(){
    ...
    download /tmp/proxy-domains.txt https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/proxy-domains.txt
...
install_sniproxy(){
    ...
    download /tmp/sniproxy-domains.txt https://qtycloud.githubaccelerate.workers.dev/https://raw.githubusercontent.com/qtyunblog/dnsmasq_sniproxy_install/master/proxy-domains.txt
